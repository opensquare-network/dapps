...
import { fetchFundBounties, fundBountiesSelector } from "../../store/reducers/profileSlice";
...
export default function FundBounites() {
  ...
  const result = useSelector(fundBountiesSelector)
